package com.algaworks.algafood.core.security.autorizationserver;// Solução baseada em: https://github.com/spring-projects/spring-security-oauth/pull/675/files
